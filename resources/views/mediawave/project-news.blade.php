    ...
    <main class="uk-width-1-1">
        <div class="md-container">
            ...
            <ul class="uk-grid uk-grid-medium" data-uk-grid data-uk-grid-margin>
                ...
                @include('mediawave.project-news.trend')

                @include('mediawave.project-news.pie')

                @include('mediawave.project-news.bar-wordcloud')

                @include('mediawave.project-news.conversation')
            </ul>
        </div>
    </main>
@endsection
